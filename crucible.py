...
SCRIPT_VERSION='e7397cdea74c06e408b2e5795f16d9b9'
...
class Configuration(object):
    ...
    def fill_from_defaults(self):
        self.url, self.username = self.url or 'http://is-2098s-macbook-pro.local:8060', self.username or 'rajendra'
        return self
    ...
    def get_patch(self):
        ...
        for line in opened:
            ...
            if match:
                ...
                # to be kept consistent with DiffHeaderParser.P4NEW
